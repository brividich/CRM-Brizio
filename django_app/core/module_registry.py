...
MODULE_DEFINITIONS: dict[str, ModuleDefinition] = {
    ...
    "ai_assistant": ModuleDefinition(
        key="ai_assistant",
        default_label="Assistente AI",
        icon="message-square",
        order=15,
        route_name="ai_assistant:chat",
        route_namespace="ai_assistant",
        permission_namespace="ai_assistant",
        navigation_codes=("ai_assistant",),
        default_short_label="AI",
        default_menu_label="Assistente AI",
        default_dashboard_label="Assistente AI",
    ),
    ...
    "tasks": ModuleDefinition(
        ...
        default_short_label="KICK-OFF",
        default_menu_label="KICK-OFF",
        default_dashboard_label="KICK-OFF",
    ),
