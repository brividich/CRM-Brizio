...
urlpatterns = [
    ...
    path("assets/manutenzione/copertura/matrice/", views.maintenance_coverage_matrix, name="maintenance_coverage_matrix"),
    ...
    path("assets/workorders/<int:id>/set-state/", views.workorder_set_state, name="wo_set_state"),
