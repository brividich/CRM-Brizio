...
- Nel dettaglio del singolo asset, la tabella `Manutenzione pianificata` e il riquadro `Prossima manutenzione` permettono di aprire direttamente l'OdL relativo alla regola della riga; l'azione resta disponibile anche con stato `Prima esecuzione da pianificare`.
