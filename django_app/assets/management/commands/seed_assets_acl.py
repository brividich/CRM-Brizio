...
PULSANTI = [
    ...
    ("asset_deadlines", "Asset - Scadenze Normativa", "asset_administrative_deadline_list"),
    ("asset_deadline_create", "Asset - Scadenza normativa nuova", "asset_administrative_deadline_create"),
    ("asset_deadline_edit", "Asset - Scadenza normativa modifica", "asset_administrative_deadline_edit"),
