...
urlpatterns = [
    ...
    path("tasks/impostazioni/record/kickoff/<int:project_id>/elimina/", views.impostazioni_kickoff_delete, name="impostazioni_kickoff_delete"),
    path("tasks/impostazioni/record/attivita/<int:task_id>/elimina/", views.impostazioni_task_delete, name="impostazioni_task_delete"),
    ...
    path("tasks/<int:task_id>/update-start-date/", views.update_start_date, name="update_start_date"),
    ...
    path("tasks/projects/<int:project_id>/incontri/<int:meeting_id>/azioni/<int:action_id>/status/", views.project_meeting_action_status, name="project_meeting_action_status"),
    path("tasks/projects/<int:project_id>/decisioni/", views.project_decisions, name="project_decisions"),
    path("tasks/projects/<int:project_id>/incontri/<int:meeting_id>/proponi-punto/", views.project_meeting_proposal_create, name="project_meeting_proposal_create"),
    path("tasks/projects/<int:project_id>/incontri/<int:meeting_id>/proposte/<int:proposal_id>/decidi/", views.project_meeting_proposal_decide, name="project_meeting_proposal_decide"),
