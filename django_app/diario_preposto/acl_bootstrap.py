...
_BOOTSTRAP_CACHE_KEY = "diario_preposto_acl_bootstrap_v1"
_BOOTSTRAP_TTL_SECONDS = 300

_PULSANTI_DEFINITIONS = [
    {
        "modulo": "diario_preposto",
        "codice": "diario_preposto_lista",
        "label": "Diario Preposto - Lista",
        "url": "/diario-preposto/",
        "hide": False,
    },
    {
        "modulo": "diario_preposto",
        "codice": "diario_preposto_nuovo",
        "label": "Diario Preposto - Nuovo inserimento",
        "url": "/diario-preposto/nuovo/",
        "hide": True,
    },
    {
        "modulo": "diario_preposto",
        "codice": "diario_preposto_dettaglio",
        "label": "Diario Preposto - Dettaglio (API)",
        "url": "/diario-preposto/dettaglio",
        "hide": True,
    },
    {
        "modulo": "diario_preposto",
        "codice": "diario_preposto_modifica",
        "label": "Diario Preposto - Modifica (API)",
        "url": "/diario-preposto/modifica",
        "hide": True,
    },
    {
        "modulo": "diario_preposto",
        "codice": "diario_preposto_elimina",
        "label": "Diario Preposto - Elimina (API)",
        "url": "/diario-preposto/elimina",
        "hide": True,
    },
    {
        "modulo": "diario_preposto",
        "codice": "diario_preposto_allegato_upload",
        "label": "Diario Preposto - Upload allegato (API)",
        "url": "/diario-preposto/api/allegato/upload/",
        "hide": True,
    },
    {
        "modulo": "diario_preposto",
        "codice": "diario_preposto_allegato_delete",
        "label": "Diario Preposto - Elimina allegato (API)",
        "url": "/diario-preposto/api/allegato/delete/",
        "hide": True,
    },
]
    ...
    if pulsante is None:
        try:
            pulsante = Pulsante.objects.create(
                codice=codice, nome_visibile=label, modulo=modulo, url=url, icona="shield"
            )
            changed = True
        except DatabaseError:
            return None, False
        ...
        with transaction.atomic():
            for defn in _PULSANTI_DEFINITIONS:
                ...
                if pid and defn.get("hide"):
                    _hide_pulsante(pid, "diario_preposto_api")
                changed = changed or item_changed
    except Exception as exc:
        logger.debug("ACL bootstrap diario_preposto skipped: %s", exc)
        return
