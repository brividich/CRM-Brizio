...
urlpatterns = [
    ...
    path("allegati/<int:allegato_id>/valida/",   views.ticket_valida_allegato,   name="valida_allegato"),
    path("<int:pk>/allegati/carica/",  views.ticket_carica_allegati,  name="carica_allegati"),
