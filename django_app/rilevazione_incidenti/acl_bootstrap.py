...
_BOOTSTRAP_CACHE_KEY = "rilevazione_incidenti_acl_bootstrap_v1"
_BOOTSTRAP_TTL_SECONDS = 300

_PULSANTI_DEFINITIONS = [
    {
        "modulo": "rilevazione_incidenti",
        "codice": "rilev_inc_lista",
        "label": "Rilevazione Incidenti - Lista rilevazioni",
        "url": "/rilevazione-incidenti/",
        "hide": False,
    },
    {
        "modulo": "rilevazione_incidenti",
        "codice": "rilev_inc_nuovo",
        "label": "Rilevazione Incidenti - Nuova rilevazione",
        "url": "/rilevazione-incidenti/nuovo/",
        "hide": False,
    },
    {
        "modulo": "rilevazione_incidenti",
        "codice": "rilev_inc_dettaglio",
        "label": "Rilevazione Incidenti - Dettaglio rilevazione",
        "url": "/rilevazione-incidenti/dettaglio",
        "hide": True,
    },
    {
        "modulo": "rilevazione_incidenti",
        "codice": "rilev_inc_modifica",
        "label": "Rilevazione Incidenti - Modifica rilevazione",
        "url": "/rilevazione-incidenti/modifica",
        "hide": True,
    },
    {
        "modulo": "rilevazione_incidenti",
        "codice": "rilev_inc_statistiche",
        "label": "Rilevazione Incidenti - Statistiche",
        "url": "/rilevazione-incidenti/statistiche/",
        "hide": False,
    },
    {
        "modulo": "rilevazione_incidenti",
        "codice": "rilev_inc_impostazioni",
        "label": "Rilevazione Incidenti - Impostazioni (admin)",
        "url": "/rilevazione-incidenti/impostazioni/",
        "hide": True,
    },
]
        ...
        with transaction.atomic():
            for defn in _PULSANTI_DEFINITIONS:
                ...
                if pid and defn.get("hide"):
                    _hide_pulsante(pid, "rilevazione_incidenti_api")
                changed = changed or item_changed
    except Exception as exc:
        logger.debug("ACL bootstrap rilevazione_incidenti skipped: %s", exc)
        return
