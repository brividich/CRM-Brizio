...
urlpatterns = [
    ...
    # Popup dell'organigramma: sta sotto `dipendenti/` di proposito, cosi' l'ACL
    # lo gate come la scheda dipendente (i dati sono quelli, in sintesi).
    path("dipendenti/<int:legacy_id>/scheda-popup/", views.organigramma_persona_popup, name="organigramma_persona_popup"),
    ...
    path("dipendenti/<int:legacy_id>/visita-facoltativa/add/", views.dipendente_visita_facoltativa_add, name="dipendente_visita_facoltativa_add"),
    path("dipendenti/<int:legacy_id>/visita-facoltativa/<int:vf_id>/remove/", views.dipendente_visita_facoltativa_remove, name="dipendente_visita_facoltativa_remove"),
    ...
    path("ruoli-operativi/<int:ruolo_id>/qualifiche/aggiungi", views.ruolo_qualifica_aggiungi, name="ruolo_qualifica_aggiungi"),
    path("ruoli-operativi/<int:ruolo_id>/qualifiche/<int:assoc_id>/rimuovi", views.ruolo_qualifica_rimuovi, name="ruolo_qualifica_rimuovi"),
    # Ambiti dei ruoli (produttivo, esecutivo, ISO 45001, ISO 27001, …)
    path("ruoli-operativi/ambiti/nuovo", views.ambito_ruolo_create, name="ambito_ruolo_create"),
    path("ruoli-operativi/ambiti/<int:ambito_id>/modifica", views.ambito_ruolo_edit, name="ambito_ruolo_edit"),
    path("ruoli-operativi/ambiti/<int:ambito_id>/elimina", views.ambito_ruolo_delete, name="ambito_ruolo_delete"),
    ...
    path("visite-mediche/<int:v_id>/superata/", views.visita_medica_superata, name="visita_medica_superata"),
    ...
    path("organigramma/diagramma/", views.organigramma_diagramma, name="organigramma_diagramma"),
    ...
    path("formazione/scansioni/impostazioni/", views.formazione_scansioni_impostazioni, name="formazione_scansioni_impostazioni"),
