...
urlpatterns = [
    ...
    path("ai-faq/", views.ai_knowledge, name="ai_knowledge"),
    path("ai/feedback/<int:feedback_id>/approva/", views.ai_feedback_approva, name="ai_feedback_approva"),
    path("ai/feedback/<int:feedback_id>/scarta/", views.ai_feedback_scarta, name="ai_feedback_scarta"),
    path("api/acl-v2/role-grant-toggle", api.api_acl_v2_role_grant_toggle, name="api_acl_v2_role_grant_toggle"),
    path("api/acl-v2/role-module-set", views.api_acl_v2_role_module_set, name="api_acl_v2_role_module_set"),
    path("api/acl-v2/user/<int:user_id>/grant-toggle", views.api_acl_v2_user_grant_toggle, name="api_acl_v2_user_grant_toggle"),
    path("api/acl-v2/user/<int:user_id>/module-set", views.api_acl_v2_user_module_set, name="api_acl_v2_user_module_set"),
    path("api/acl-v2/legacy-user-search", acl_v2_views.api_acl_legacy_user_search, name="api_acl_v2_legacy_user_search"),
    ...
    path("pdf-template/", views.pdf_template_config, name="pdf_template_config"),
    path("pdf-template/preview/", views.pdf_template_preview, name="pdf_template_preview"),
    path("api/pdf-template/save", views.api_pdf_template_config_save, name="api_pdf_template_config_save"),
    path("branding/", views.branding_config, name="branding_config"),
    path("api/branding/favicon/upload", views.api_branding_favicon_upload, name="api_branding_favicon_upload"),
    path("api/branding/favicon/remove", views.api_branding_favicon_remove, name="api_branding_favicon_remove"),
    ...
    path("ruoli/", views.ruoli_list, name="ruoli_list"),
    path("ruoli/<int:ruolo_id>/update", views.ruolo_update, name="ruolo_update"),
    path("ruoli/<int:ruolo_id>/delete", views.ruolo_delete, name="ruolo_delete"),
    path("api/ruoli/create", views.api_ruolo_create, name="api_ruolo_create"),
