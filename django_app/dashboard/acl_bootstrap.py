...
_BOOTSTRAP_CACHE_KEY = "dashboard_acl_bootstrap_v4"

_PULSANTI_DEFINITIONS = [
    {"modulo": "dashboard", "codice": "dashboard_home", "label": "Dashboard - Home", "url": "/dashboard", "hide": False},
    {
        "modulo": "dashboard",
        "codice": "dashboard_richieste",
        "label": "Dashboard - Redirect richieste -> assenze",
        "url": "/richieste",
        "hide": True,
    },
    {"modulo": "dashboard", "codice": "dashboard_anomalie_menu", "label": "Dashboard - Menu anomalie", "url": "/anomalie-menu", "hide": True},
    {"modulo": "dashboard", "codice": "dashboard_scheda_dipendente", "label": "Dashboard - Alias dashboard principale", "url": "/scheda-dipendente", "hide": False},
    ...
    {"modulo": "dashboard", "codice": "dashboard_scheda_pdf", "label": "Dashboard - PDF dashboard principale", "url": "/scheda-dipendente/pdf", "hide": True},
