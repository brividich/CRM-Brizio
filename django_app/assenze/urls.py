...
urlpatterns = [
    ...
    path("assenze/le-mie-richieste/", views.gestione_assenze, name="assenze_gestione"),
    path("assenze/impostazioni/", views.impostazioni_admin, name="assenze_impostazioni"),
