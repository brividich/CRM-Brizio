...
- **OdL dalla scheda asset**: nel `Registro manutenzione`, sia il riquadro **Prossima manutenzione** sia ogni riga di **Manutenzione pianificata** espongono `Crea intervento`, con asset e piano/regola gia precompilati anche quando manca la prima esecuzione.
