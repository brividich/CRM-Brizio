...
Gli interventi Assets supportano sia la creazione ordinaria sia il passaggio immediato alla chiusura formale, con data/ora editabile, piu giornate di esecuzione opzionali e consuntivo indicativo in ore/minuti.
...
- **Pagina manutenzione operativa** su `/assets/manutenzione/`: una sola fascia di priorita riassume interventi aperti, scaduti, attivita entro 30 giorni e completati; sotto, l'area **Lavoro operativo** ordina OdL oltre soglia/recenti, scadenze e verifiche urgenti o imminenti, regole critiche, macchine e ticket MAN, con filtri reparto/manutentore. Il rail laterale e ridotto alla sola **Agenda 7 giorni** con accessi ai registri. Lo scadenzario canonico vive in `/assets/manutenzione/prossime/`; le vecchie URL e `?tab=scadenzario` vi convergono tramite redirect compatibile.
