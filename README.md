...
- **Centro manutenzione aziendale** su `/assets/manutenzione/`: e' l'hub unico per priorita operative e accesso a interventi, piani ordinari, catalogo attivita e storico. Il flusso dei ticket MAN resta quello esistente e viene richiamato nell'hub senza duplicarne gestione o stati. Lo scadenzario canonico vive in `/assets/manutenzione/prossime/`; le vecchie URL e `?tab=scadenzario` vi convergono tramite redirect compatibile.
