...
- **Kickoff = progetto** con numerazione automatica `KICK-OFF <progressivo>` e nome proposto **`Cliente · P/N · KICK-OFF <progressivo>`** (campo *Nome del kickoff* nel form di creazione: vuoto usa la proposta, che si vede come segnaposto mentre si compilano cliente e P/N; i kickoff esistenti non vengono rinominati)
