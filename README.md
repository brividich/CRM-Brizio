...
![Version 0.9.17](https://img.shields.io/badge/version-0.9.17-F97316)
...
Su ambienti SQL Server con automazioni gia attive, dopo gli upgrade riesegui anche `sql/automation_event_queue.sql` per riallineare la queue tecnica senza ricrearla.
