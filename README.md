...
- **Ricerca globale formazione** (`/anagrafica/formazione/ricerca/`, gated `AnagraficaFormazionePermission`): casella di ricerca nella dashboard Formazione che cerca in un colpo solo **corsi, sessioni, piani, qualifiche/abilitazioni, dipendenti** (→ libretto) e **attestati** (per titolo corso o nominativo, su campi snapshot), con pagina risultati raggruppata per tipo.
