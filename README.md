...
| 10 | [`tasks`](django_app/tasks/) | Operations | `/tasks/` | Portfolio **KICK-OFF** progetti, attività, Gantt con drag spostamento/resize, timeline eventi leggibile, incontri avanzamento, VRF (MOD.073), **indicatore di prontezza all'avvio** (gate 4 criteri), blocco progressivo, flag impatto sicurezza |
