...
**Ordine consigliato Ondata 6**: ~~6.1~~ ✅ → ~~6.2~~ ✅ → 6.3 (complemento di 6.2, stesso modulo) → ~~6.4~~ ✅ → ~~6.5~~ ✅.
**Resta solo 6.3** (tool live Schede Sicurezza: "quale scheda per prodotto X", "chi non ha preso visione").

**Stato avanzamento Ondata 6**: ✅ 6.1 Tool Contatori MFC · ✅ 6.2 RAG Schede Sicurezza · ✅ 6.4 Suggestion Corner (tool aggregati + copilota preesistente) · ✅ 6.5 Assets OdL interne/esterne (2026-07-12, branch `feat/modulo-security-center`).
