...
**Correzione audit 2026-09-25 completata:** migration `0004` per l'indice unico filtrato degli esiti; blocco del rapporto firmato con riapertura esplicita e route ACL; convalida del responsabile di processo; KPI sulla sola revisione MOD.034 approvata e sui mesi del periodo; imparzialitÃ  a token interi; retry OFI con savepoint; download firmati tracciati; PDF riconfrontati con i modelli originali. Aggiunte regressioni dedicate e ripetuta la verifica UI in tema chiaro/scuro con sessioni nuove.
